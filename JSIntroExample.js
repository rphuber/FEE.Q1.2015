...
var getAverageTime = function(person) {
    ...
    // Demo 3 - Using for...in loop on the object to get back the values at each key
...
function getSumOfAccounts(account) {
    "use strict";
    var sum = 0;
    Object.keys(account).forEach(function(element, index, array){
      sum += parseInt(account[element]);
    });
    // return ...
    return sum;
};
